...
export default  function Footer() {
     return (
            <footer class="footer dark-box">
                <div class="container flex-box">
                    <div class="logo"><span class="logo_green logo_bold">pro</span>coder<span class="logo_green logo_bold">_</span></div>
                    <a class="team-link flex-box" href="https://github.com/NYehor/Procoder">
                        <i class="github-icon">
                            <svg width="30px" height="30px" viewBox="0 0 35.318 35.318">
